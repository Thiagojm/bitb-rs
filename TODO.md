...
- `examples/bitb_lab.rs`: manual bits/raw/fold, `u64`, range, preview, descriptive statistics, and throughput laboratory.
...
- Public GitHub repository metadata and MIT licensing are configured.
...
3. Before wider release: review static libusb/LGPL distribution obligations.
